...
<section id="borrow" class="container">
    ...
    <table class="table table-hover">
        ...
        <tbody>
            <tr>
                <td scope="row">王五</td>
                <td class="hidden-xs">江湖救急111111111111111111111111111111111111111</td>
                <td>12%</td>
                <td>100</td>
                <td>2000</td>
                <td>按月分期还款</td>
            ...
            <tr>
                <td scope="row">王五</td>
                <td class="hidden-xs">江湖救急1111111111111111111111111111111111</td>
                <td>12%</td>
                <td>100</td>
                <td>2000</td>
                <td>按月分期还款</td>
